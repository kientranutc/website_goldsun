                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <p class="lead"> Chúc mừng bạn  đã được tạo tài khoản tại hệ thống <a href="http://goldsunmachinery.vn"> GOLDSUN_CNC </a> thành công ! </p>
                            ...
                            <!-- Callout Panel -->
                            <p class="callout">
                                Vui lòng đăng nhập và đổi mật khẩu cá nhân  <a href="{{URL::route('auth.login')}}">tại đây! &raquo;</a>
                            </p><!-- /Callout Panel -->
                                        ...
                                        <table align="left" class="column">
                                            <tr>
                                                <td>
                                                    ...
                                                    Email: <strong><a href="emailto:kienkienutc95@gmail.com">admin@goldsunmachinery.vn</a></strong></p>

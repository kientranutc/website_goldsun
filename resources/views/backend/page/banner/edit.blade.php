        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{URL::route('banner.post-edit',['id'=>$dataEdit->id])}}" method="post">
                        {{csrf_field()}}
                        <div class="box-body">
                            ...
                            <div class="form-group {{($errors->has('link'))?"has-error":""}}">
                                ...
                                <input type="text" name="link" value="{{old('link')?old('link'):$dataEdit->link}}" class="form-control" id="exampleInputPassword1" placeholder="Linh liên kết">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="radio">
                                            <label>
                                                <input type="radio"  name="active" id="optionsRadios1" value="1" {{($dataEdit->active==1)?"checked":""}}>
                                                Hiển thị
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="radio">
                                            <label><input type="radio" name="active" id="optionsRadios2" value="0" {{($dataEdit->active==0)?"checked":""}}>
                                                Ẩn
                                            </label>
                                        </div>
                                    </div>

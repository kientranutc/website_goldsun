                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{($errors->has('name_en'))?"has-error":""}}">
                                        ...
                                        <input type="text" name="name_en" value="{{old('name_en')}}" class="form-control" id="exampleInputPassword1" placeholder="Tên danh mục (Tiếng việt)">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{($errors->has('name_vi'))?"has-error":""}}">
                                        ...
                                        <input type="text" name="name_vi" value="{{old('name_vi')}}" class="form-control" id="exampleInputPassword1" placeholder="Tên danh mục (Tiếng anh)">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description_vi" class="form-control" id="description_vi" cols="30" rows="10"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description_en" class="form-control" id="description_en" cols="30" rows="10"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box-body" style="overflow-y: scroll; height: 600px">
                        <ul class="nav">
                            ...
                            <li>
                                <div class="form-group">
                                    <label for="{{$item->id}}">
                                        <input type="checkbox" name="category[]" value="{{$item->id}}" id="{{$item->id}}" class="flat-red">
                                        {{$item->name_vi}}
                                    </label>
                                </div>
                            </li>
                            <li>
                                <ul class="nav" style="margin-left: 30px">
                                    ...
                                    <li>
                                        <div class="form-group">
                                            <label for="{{$val->id}}">
                                                <input type="checkbox" category[] id="{{$val->id}}" value="{{$val->id}}" class="flat-red" >
                                                {{$val->name_vi}}
                                            </label>
                                        </div>
                                    </li>
